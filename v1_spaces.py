...
class Variation:
    def __init__(self, act_attr_to_rmv=set(), obs_attr_to_rmv=set()):
        ...
        self.env_configs = {
            'Random': {"obs_attr_to_keep": list(self.obs_attr_to_keep), 'act_type': "discrete", "act_attr_to_keep": list(self.act_attr_to_keep)},
            'PPO': {"obs_attr_to_keep": list(self.obs_attr_to_keep), 'act_type': "discrete", "act_attr_to_keep": list(self.act_attr_to_keep)},
            'A2C': {"obs_attr_to_keep": list(self.obs_attr_to_keep), 'act_type': "discrete", "act_attr_to_keep": list(self.act_attr_to_keep)},
        }
